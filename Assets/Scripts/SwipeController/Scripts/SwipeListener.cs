...
namespace GG.Infrastructure.Utils.Swipe
{
    ...
    public class SwipeListener : MonoBehaviour
    {
        ...
        [SerializeField] float _sensetivity = 10;
        [SerializeField] bool _continuousDetection;
        [SerializeField] SwipeDetectionMode _swipeDetectionMode = SwipeDetectionMode.EightSides;

        float _minMoveDistance = 0.1f;
        bool _waitForSwipe = true;
        Vector3 _swipeStartPoint;
        Vector3 _offset;
        VectorToDirection _directions;
